...
from watchdog.events import FileSystemEventHandler, DirDeletedEvent, DirModifiedEvent
...
def handle_kindle_mount(ankikindle_injection, ankiconnect_injection, mount_dir_root, kindle_device_name):
